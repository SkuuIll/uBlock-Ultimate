...
class RedirectEntry {
    ...
    toURL(fctxt, asDataURI = false) {
        ...
        if ( this.data === '' ) {
            if ( fctxt instanceof Object === false ) { return; }
