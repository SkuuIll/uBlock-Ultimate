...
(function() {
    ...
    function localRead(key) {
        try {
            ...
            console.warn('[uBR] picker-ui: localStorage read failed', e);
        }
    ...
    function storageGet(keys) {
        ...
        try {
            ...
            console.warn('[uBR] picker-ui: storage.get failed', e);
        }
    ...
    function storageSet(items) {
        ...
        try {
            ...
            console.warn('[uBR] picker-ui: storage.set failed', e);
        }
        return new Promise((resolve) => {
    ...
    function onPreviewClicked() {
        ...
        updatePreview();
        qs('#preview').textContent = state
            ? (getMsg('pickerPreviewUndo') || 'Undo')
            : (getMsg('pickerPreview') || 'Preview');
    ...
    function onCreateClicked() {
        ...
        updatePreview(false);
        overlayPostMessage({ what: 'createUserFilter', filter });
        overlayPostMessage({ what: 'confirmSelection', filter });
        toolOverlay.stop();
    }
    ...
    function updatePreview(state) {
        ...
        return overlayPostMessage({
            what: 'previewSelector',
            selector,
        }).then(result => {
