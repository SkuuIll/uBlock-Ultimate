    ...
    const parts = [
        ...
        `function(details) {
            ...
            try {
                ...
                console.warn('[uBlock Ultimate] vapi-background-ext: direct script injection failed', e);
            }
            if ( script ) {
                script.remove();
                script.textContent = '';
            ...
            try {
                ...
                console.warn('[uBlock Ultimate] vapi-background-ext: blob script injection failed', e);
            }
            if ( url ) {
