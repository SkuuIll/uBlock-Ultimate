...
function hrefSanitizer(
    ...
    const sanitizeCopycats = (href, text) => {
        ...
        try {
            ...
            console.warn('[uBlock Ultimate] href-sanitizer: sanitizeCopycats querySelectorAll failed', e);
        }
    ...
    const validateURL = text => {
        ...
        try {
            ...
            console.warn('[uBlock Ultimate] href-sanitizer: validateURL failed', e);
        }
        return '';
    };
    ...
    const sanitize = ( ) => {
        ...
        try {
            ...
            console.warn('[uBlock Ultimate] href-sanitizer: sanitize querySelectorAll failed', e);
            return false;
        }
        for ( const elem of elems ) {
