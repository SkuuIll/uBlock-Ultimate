...
export function collateFetchArgumentsFn(resource, options) {
    ...
    if (
        ...
        try {
            ...
            console.warn('[uBlock Ultimate] utils: Request_clone failed', e);
        }
    ...
    for ( const obj of objs ) {
        ...
        for ( const [ prop, details ] of propNeedles ) {
            ...
            if ( typeof value !== 'string' ) {
                ...
                catch (e) { console.warn('[uBlock Ultimate] utils: matchObjectPropertiesFn JSON_stringify failed', e); }
...
export function generateContentFn(trusted, directive) {
    ...
    if ( directive.startsWith('war:') ) {
        ...
        return new Promise(resolve => {
            ...
            console.warn('[uBlock Ultimate] resources/utils: WAR fetch failed', e);
            return '';
        });
    }
