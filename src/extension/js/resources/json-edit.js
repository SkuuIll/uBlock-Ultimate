...
function editInboundObjectFn(
    ...
    const editObj = obj => {
        ...
        try {
            ...
            console.warn('[uBlock Ultimate] json-edit: JSON clone failed', e);
        }
    ...
    self.XMLHttpRequest = class extends self.XMLHttpRequest {
        ...
        get response() {
            ...
            if ( typeof innerResponse === 'object' ) {
                ...
                try { obj = safe.JSON_parse(innerResponse); } catch (e) { console.warn('[uBlock Ultimate] json-edit: JSON_parse innerResponse failed', e); }
            }
...
function jsonEditXhrRequestFn(trusted, jsonq = '') {
    ...
    self.XMLHttpRequest = class extends self.XMLHttpRequest {
        ...
        #filterBody(body) {
            ...
            catch (e) { console.warn('[uBlock Ultimate] json-edit: JSON_parse body failed', e); }
...
function jsonEditFetchRequestFn(trusted, jsonq = '') {
    ...
    const filterBody = body => {
        ...
        let data;
        try { data = safe.JSON_parse(body); }
        catch (e) { console.warn('[uBlock Ultimate] json-edit: filterBody JSON_parse failed', e); }
        if ( data instanceof Object === false ) { return; }
        const objAfter = jsonp.apply(data);
        if ( objAfter === undefined ) { return; }
...
function jsonlEditFn(jsonp, text = '') {
    ...
    for ( const lineBefore of linesBefore ) {
        let obj;
        try { obj = safe.JSON_parse(lineBefore); } catch (e) { console.warn('[uBlock Ultimate] json-edit: jsonlEditFn JSON_parse failed', e); }
        if ( typeof obj !== 'object' || obj === null ) {
