...
function abortCurrentScriptFn(
    ...
    const getScriptText = elem => {
        ...
        try {
            ...
            console.warn('[uBlock Ultimate] scriptlets: decode content failed', e);
        }
...
function removeClass(
    ...
    const rmclass = ( ) => {
        ...
        try {
            ...
            console.warn('[uBlock Ultimate] scriptlets: rmclass querySelectorAll failed', e);
        }
        if ( mustStay ) { return; }
...
function xmlPrune(
    ...
    const pruneFromText = text => {
        ...
        try {
            ...
            console.warn('[uBlock Ultimate] scriptlets: json-prune XML parse failed', e);
        }
        return text;
    };
        ...
        apply: function(target, thisArg, args) {
            ...
            return fetchPromise.then(responseBefore => {
                ...
                return response.text().then(text => {
                    ...
                    console.warn('[uBlock Ultimate] scriptlets: json-prune response text failed', e);
                    return responseBefore;
                });
            });
        }
    ...
    owner[prop] = new Proxy(fn, {
        apply: function(...args) {
            ...
            try {
                ...
                console.warn('[uBlock Ultimate] scriptlets: proxy-apply fn failed', e);
            }
            return r;
        },
    });
...
function trustedReplaceOutboundText(
    ...
    proxyApplyFn(propChain, (context) => {
        ...
        if ( extraArgs.encoding === 'base64' ) {
            ...
            catch (e) { console.warn('[uBlock Ultimate] scriptlets: atob decode failed', e); return encodedTextBefore; }
        }
        if ( rawPattern === '' ) {
    ...
    proxyApplyFn(methodPath, (context) => {
        ...
        for ( const elem of elems ) {
            try {
                ...
                console.warn('[uBlock Ultimate] scriptlets: prevent-element-src-loading bypass failed', e);
            }
        }
        return r;
    });
    ...
    proxyApplyFn(methodPath, (context) => {
        ...
        if ( override === false ) {
            ...
            try {
                ...
                console.warn('[uBlock Ultimate] scriptlets: override-element-method selector check failed', e);
            }
        }
        if ( override === false ) {
            return context.reflect();
