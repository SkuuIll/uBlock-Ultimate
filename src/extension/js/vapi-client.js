/*******************************************************************************
    ...
    Copyright (C) 2014-2015 upstream contributors
...
vAPI.messaging = {
    ...
    messageListener: function(details) {
        ...
        const entry = this.pending.get(details.msgId);
        if ( entry === undefined ) { return; }
        this.pending.delete(details.msgId);
        clearTimeout(entry.timer);
        entry.resolve(details.msg);
    },
    ...
    try {
        ...
        if ( this.port === null || webextAPI?.runtime?.lastError ) {
            ...
            if ( this.shuttingDown === false ) {
                console.log('[uBlock Ultimate] vapi-client: runtime.connect failed — extension context invalidated');
                this.shuttingDown = true;
            }
            this.port = null;
        }
    ...
    send: function(channel, msg, timeoutMs) {
